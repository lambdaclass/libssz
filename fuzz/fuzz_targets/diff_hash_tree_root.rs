...
//! Differential hash_tree_root fuzzer: compute hash_tree_root with libssz and
//! tree_hash (Lighthouse), then assert identical 32-byte roots.
//! Note: tree_hash doesn't implement TreeHash for u128, so we skip that.
